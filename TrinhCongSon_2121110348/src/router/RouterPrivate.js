...
import SinglePageList from '../pages/backend/SinglePage/SinglePageList';
import SinglePageCreate from '../pages/backend/SinglePage/SinglePageCreate';
import SinglePageUpdate from '../pages/backend/SinglePage/SinglePageUpdate';
import SinglePageShow from '../pages/backend/SinglePage/SinglePageShow';
import PostDetailList from '../pages/backend/PostDetail/PostDetailList';
import PostDetailCreate from '../pages/backend/PostDetail/PostDetailCreate';
import PostDetailUpdate from '../pages/backend/PostDetail/PostDetailUpdate';
import PostDetailShow from '../pages/backend/PostDetail/PostDetailShow';
...
const RouterPrivate=[
    ...
    {path:'/admin/singlepage', component:SinglePageList},
    {path:'/admin/singlepage/create', component:SinglePageCreate},
    {path:'/admin/singlepage/update/:id', component:SinglePageUpdate},
    {path:'/admin/singlepage/show/:id', component:SinglePageShow},

    {path:'/admin/postdetail', component:PostDetailList},
    {path:'/admin/postdetail/create', component:PostDetailCreate},
    {path:'/admin/postdetail/update/:id', component:PostDetailUpdate},
    {path:'/admin/postdetail/show/:id', component:PostDetailShow},
